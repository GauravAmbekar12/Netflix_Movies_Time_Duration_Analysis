...
movie_dict = {"years":years,"durations":duration}
movie_dict
...
movies_col_subset = df_movies_only[['title','country','genre','release_year','duration']]

# Print the first five rows of the new DataFrame
movies_col_subset.head()
...
plt.scatter(movies_col_subset['release_year'],movies_col_subset['duration'])

# Create a title
plt.title("Duration by year of release")
...
short_movies = movies_col_subset[movies_col_subset['duration']<60]
...
# Iterate over rows of movies_col_subset
for lab,row in movies_col_subset.iterrows() :
...
plt.style.use('fivethirtyeight')                                   #use 1st time
fig = plt.figure(figsize=(12,8))
...
are_movies_getting_shorter = "certain"
